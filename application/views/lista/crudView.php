    ...
    <br>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <td> <a href="<?php echo base_url('index.php/Crud/edit');?>/<?php echo $row->usua_id?>">Edit</a>   
                   <a href="<?php echo base_url('index.php/Crud/delete');?>/<?php echo $row->usua_id;?>">Delete</a> </td>
                </tr>
                <?php } ?>
            </tbody>
        </table>
